    ...
    <>
      <div className="nav p-2 bg-blue-950 text-white flex justify-between pl-7">
        ...
        <div className="options flex gap-7 px-3 py-1 ">
          ...
          <NavLink to ="/" className="bg-blue-900 py-[3px] w-[100px] text-center  rounded-lg px-[10px] hover:bg-blue-800">Home</NavLink>
          }
          { !localStorage.getItem("user") || localStorage.getItem("user") == "9999" && 
          <NavLink to ="/" className="bg-blue-900 py-[3px] w-[100px] text-center  rounded-lg px-[10px] hover:bg-blue-800">Sign Up</NavLink>
          }
          {localStorage.getItem("user") && localStorage.getItem("user") != "9999" && 
          <NavLink to ="/frnds" className="bg-blue-900 py-[3px] w-[100px] text-center  rounded-lg px-[10px] hover:bg-blue-800">Find</NavLink>
          }
          { !localStorage.getItem("user") || localStorage.getItem("user") == "9999" && 
          <NavLink to ="/" className="bg-blue-900 py-[3px] w-[100px] text-center  rounded-lg px-[10px] hover:bg-blue-800">2</NavLink>
          }
